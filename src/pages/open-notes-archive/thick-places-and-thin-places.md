...
With the difference now laid before us we have a choice.  We can either choose to avoid thick places or labour to create thin ones. And while its clear that one path is trafficked more than the other, without people who are willing to create thin places we’ll eventually corrupt and turn thick all the places marked by the absence of The System. Thankfully, we all have the ability to  create thin places, and all we have to do to make them is choose the path less traveled. 